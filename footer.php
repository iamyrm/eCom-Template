...
<footer class="footer footer-2">
  ...
  <!-- Newsletter  -->
  <?php include("parts/footer/newsletter.php"); ?>

  <!-- Main Footer  -->
  <?php include("parts/footer/main-footer.php"); ?>

  <!-- Bottom Footer  -->
  <?php include("parts/footer/bottom-footer.php"); ?>
...
<!-- Popup Newsletter  -->
<?php //include("parts/newsletter-popup.php"); 
?>
...
<!-- Custom inhouse JS  -->
<script src="assets/inhouse/script.js"></script>
</body>
